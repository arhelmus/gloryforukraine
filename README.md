...
Запуск через докер: `docker run --env SCHEDULED_TARGETS_URL=https://gloryforukraine.pages.dev/scheduled_targets.json PARALLEL_FACTOR=1 --rm -it archdev/gloryforukraine`
